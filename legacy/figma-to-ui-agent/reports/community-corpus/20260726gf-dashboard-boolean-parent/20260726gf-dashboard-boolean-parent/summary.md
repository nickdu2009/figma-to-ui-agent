...
- runId: 20260726gf-dashboard-boolean-parent
...
- nodes: {"text":114,"input":0,"button":0,"image":4,"pixelOverlay":100,"total":341}
- structuredCoverage: text=114, interactive=0
- visualLayerCoverage: candidate=128, rendered=123, unsupported=5
...
- diffPixels: 89988
- diffPixelRatio: 0.06102701822916667
- screenshots: runs/ms1n2lqt-17a36fa237d84560b635c094d835a763/screenshots/000-72e60729bf19-expected.png, runs/ms1n2lqt-17a36fa237d84560b635c094d835a763/screenshots/000-72e60729bf19-actual.png, runs/ms1n2lqt-17a36fa237d84560b635c094d835a763/diffs/000-72e60729bf19-diff.png
...
|---|---:|---:|---|
| visual_assets | 6.10% | 89988 | 0,0,1440x1024 |
| text_regions | 6.85% | 85793 | 122,30,1288x972 |

##### top failing regions

| region | bucket | diff | pixels | suspectedCauses |
|---|---|---:|---:|---|
| dense_content | text_regions | 6.85% | 85793 | typography |
| dense_content | visual_assets | 6.10% | 89988 | asset_layering |
| dense_content | - | 6.10% | 89988 | renderer_reset |
