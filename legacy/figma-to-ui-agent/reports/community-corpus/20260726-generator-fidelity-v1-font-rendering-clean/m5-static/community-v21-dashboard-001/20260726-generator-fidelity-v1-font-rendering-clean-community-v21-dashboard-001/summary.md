...
- runId: 20260726-generator-fidelity-v1-font-rendering-clean-community-v21-dashboard-001
...
- nodes: {"text":114,"input":0,"button":0,"image":4,"pixelOverlay":100,"total":334}
- structuredCoverage: text=114, interactive=0
- visualLayerCoverage: candidate=160, rendered=156, unsupported=12
...
- diffPixels: 162281
- diffPixelRatio: 0.11005384657118056
- screenshots: runs/ms1alupw-635c4c505305473784cc05e90d7dfc6d/screenshots/000-72e60729bf19-expected.png, runs/ms1alupw-635c4c505305473784cc05e90d7dfc6d/screenshots/000-72e60729bf19-actual.png, runs/ms1alupw-635c4c505305473784cc05e90d7dfc6d/diffs/000-72e60729bf19-diff.png
...
|---|---:|---:|---|
| visual_assets | 11.01% | 162281 | 0,0,1440x1024 |
| text_regions | 10.83% | 135595 | 122,30,1288x972 |

##### top failing regions

| region | bucket | diff | pixels | suspectedCauses |
|---|---|---:|---:|---|
| left_visual | visual_assets | 11.01% | 162281 | asset_layering |
| mobile_canvas | - | 11.01% | 162281 | canvas_mapping |
| footer | text_regions | 10.83% | 135595 | typography |
...
| 0:121 | structural_visual | decorative_background | false | - |
...
- sourceNodeCount: 496
- visibleNodeCount: 496
- vector: total=262, rendered=170, ignoredSafe=0, unsupported=92, unmapped=0
...
- byReason: {"unsupported_renderer_limit":88,"unsupported_missing_asset":4}
- byKind: {"vector":92}
...
- 0:121 (vector, unsupported_missing_asset, area=400): Rectangle 8
