...
- runId: 20260727-residual-fixes-r4-community-v21-dashboard-001
...
- nodes: {"text":114,"input":0,"select":0,"button":0,"image":4,"pixelOverlay":104,"total":352}
...
- visualLayerCoverage: candidate=176, rendered=176, unsupported=0
...
- diffPixels: 65958
- diffPixelRatio: 0.04473063151041667
- screenshots: runs/ms2rfcu5-311d65c7a8ea4767989d6ed2822dbe77/screenshots/000-72e60729bf19-expected.png, runs/ms2rfcu5-311d65c7a8ea4767989d6ed2822dbe77/screenshots/000-72e60729bf19-actual.png, runs/ms2rfcu5-311d65c7a8ea4767989d6ed2822dbe77/diffs/000-72e60729bf19-diff.png
...
|---|---:|---:|---|
| visual_assets | 4.47% | 65958 | 0,0,1440x1024 |
| text_regions | 4.90% | 61369 | 122,30,1288x972 |
| button_icon_controls | 4.16% | 44020 | 29,44,1143x925 |

##### top failing regions

| region | bucket | diff | pixels | suspectedCauses |
|---|---|---:|---:|---|
| dense_content | text_regions | 4.90% | 61369 | typography |
| dense_content | visual_assets | 4.47% | 65958 | asset_layering |
| dense_content | - | 4.47% | 65958 | renderer_reset |
| cta | button_icon_controls | 4.16% | 44020 | asset_layering, renderer_reset |
...
| 0:19 | nav_icon | icon | true | vl-light---dashboard---1-0-19 |
| 0:28 | nav_icon | icon | true | vl-light---dashboard---1-0-28 |
| 0:42 | nav_icon | icon | true | vl-light---dashboard---1-0-42 |
...
- sourceNodeCount: 496
- visibleNodeCount: 496
- vector: total=262, rendered=182, ignoredSafe=0, unsupported=80, unmapped=0
...
- byReason: {"unsupported_renderer_limit":80}
- byKind: {"vector":80}

- 0:314 (vector, unsupported_renderer_limit, area=252): Fill 134
- 0:313 (vector, unsupported_renderer_limit, area=252): Path
- 0:334 (vector, unsupported_renderer_limit, area=247): Fill 159
- 0:333 (vector, unsupported_renderer_limit, area=247): Path
- 0:296 (vector, unsupported_renderer_limit, area=227): Fill 122
- 0:298 (vector, unsupported_renderer_limit, area=227): Path
- 0:253 (vector, unsupported_renderer_limit, area=171): Fill 221
- 0:254 (vector, unsupported_renderer_limit, area=171): Path
- 0:257 (vector, unsupported_renderer_limit, area=171): Fill 222
- 0:258 (vector, unsupported_renderer_limit, area=171): Path
