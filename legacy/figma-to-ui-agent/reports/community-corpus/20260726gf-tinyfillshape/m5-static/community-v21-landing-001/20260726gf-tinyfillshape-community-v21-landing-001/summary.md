...
- runId: 20260726gf-tinyfillshape-community-v21-landing-001
...
- nodes: {"text":13,"input":0,"button":1,"image":0,"pixelOverlay":15,"total":124}
- structuredCoverage: text=13, interactive=1
- visualLayerCoverage: candidate=18, rendered=18, unsupported=0
...
- diffPixels: 74351
- diffPixelRatio: 0.04018104193687851
- screenshots: runs/ms1fl3ng-5155c3105e104842853a01af553b011f/screenshots/000-f96ca2270afe-expected.png, runs/ms1fl3ng-5155c3105e104842853a01af553b011f/screenshots/000-f96ca2270afe-actual.png, runs/ms1fl3ng-5155c3105e104842853a01af553b011f/diffs/000-f96ca2270afe-diff.png
...
|---|---:|---:|---|
| visual_assets | 3.77% | 43399 | 148,96,1153x999 |
| text_regions | 4.62% | 73162 | 0,161,1440x1100 |
...
| footer | text_regions | 4.62% | 73162 | typography |
| dense_content | - | 4.02% | 74351 | renderer_reset |
| left_visual | visual_assets | 3.77% | 43399 | asset_layering |

## 视觉层追溯

| sourceNodeId | reason | layerRole | rendered | uiSpecNodeId |
|---|---|---|---|---|
| 14:1006 | nav_icon | icon | true | vl-home-14-1006 |
| 14:1008 | nav_icon | icon | true | vl-home-14-1008 |
| 14:1007 | nav_icon | icon | true | vl-home-14-1007 |
...
- sourceNodeCount: 396
- visibleNodeCount: 396
- vector: total=291, rendered=261, ignoredSafe=0, unsupported=30, unmapped=0
...
- byReason: {"unsupported_renderer_limit":30}
- byKind: {"vector":30}
...
- 211:841 (vector, unsupported_renderer_limit, area=65): Vector
- 211:837 (vector, unsupported_renderer_limit, area=46): Vector
- 211:838 (vector, unsupported_renderer_limit, area=42): Vector
