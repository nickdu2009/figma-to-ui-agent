...
- runId: product-m9-trego-target-backfill-20260810t0012
- status: partial
- ok: false
- mode: restricted-live
- projectId: product-m9-trego-target-backfill-008
- designBundlePath: data/projects/product-m9-trego-target-backfill-008/figma/current.json
- uiSpecPath: data/projects/product-m9-trego-target-backfill-008/specs/current.json
- flowPlanPath: reports/product-m9/product-m9-trego-target-backfill-20260810t0012/confirmed-flow-plan.json
- confirmedFlowPlanPath: reports/product-m9/product-m9-trego-target-backfill-20260810t0012/confirmed-flow-plan.json
- validationPath: reports/product-m9/product-m9-trego-target-backfill-20260810t0012/flow-m11-summary.json
...
- confirmation: passed - Flow-M10 confirmation answers applied=1 declined=32 rejected=0
