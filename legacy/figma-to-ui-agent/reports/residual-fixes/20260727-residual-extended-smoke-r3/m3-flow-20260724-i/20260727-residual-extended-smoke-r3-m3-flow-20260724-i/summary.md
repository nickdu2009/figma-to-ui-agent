...
- runId: 20260727-residual-extended-smoke-r3-m3-flow-20260724-i
...
- viewportRole: desktop
- nodes: {"text":13,"input":6,"select":0,"button":3,"image":3,"pixelOverlay":4,"total":45}
...
- visualLayerCoverage: candidate=10, rendered=8, unsupported=2
