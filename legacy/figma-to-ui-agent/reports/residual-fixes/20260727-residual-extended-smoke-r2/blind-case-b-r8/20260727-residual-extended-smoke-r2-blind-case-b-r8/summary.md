...
- runId: 20260727-residual-extended-smoke-r2-blind-case-b-r8
...
- viewportRole: mobile
- nodes: {"text":12,"input":0,"select":0,"button":1,"image":1,"pixelOverlay":1,"total":60}
...
- visualLayerCoverage: candidate=35, rendered=33, unsupported=4
...
- sourceNodeCount: 75
- visibleNodeCount: 75
- vector: total=41, rendered=25, ignoredSafe=0, unsupported=16, unmapped=0
...
- byReason: {"unsupported_renderer_limit":14,"unsupported_missing_asset":2}
- byKind: {"vector":16}
...
- I728:1891;424:634;94:1727 (vector, unsupported_renderer_limit, area=10): Vector
