...
const baselineFiles = [
  ...
  "preview/src/components/controlled-style.ts",
  "preview/src/components/form-controls.tsx",
  "preview/src/components/layout.tsx",
  "preview/src/components/media.tsx",
  "preview/src/components/navigation.tsx",
  "preview/src/components/typography.tsx",
  "preview/src/main.tsx",
  "preview/src/preview-app.tsx",
  "preview/src/styles.css",
  "scripts/prepare-m3.mjs",
  ...
  "tests/e2e/p1-components.spec.ts",
  ...
  "tests/unit/tools/unsupported-features.test.ts",
