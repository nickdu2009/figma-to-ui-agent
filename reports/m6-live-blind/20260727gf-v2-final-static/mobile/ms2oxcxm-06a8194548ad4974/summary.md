...
- runId: ms2oxcxm-06a8194548ad4974
- projectId: m6-live-community-mobile-001-font-r1
...
- viewportRole: tablet
- nodes: {"text":24,"input":0,"select":0,"button":1,"image":1,"pixelOverlay":17,"total":59}
...
- visualLayerCoverage: candidate=17, rendered=17, unsupported=1
...
- diffPixels: 4538
- diffPixelRatio: 0.011221646055732361
- screenshots: runs/ms2oxcxv-fc2bec4f08dd4e2ea18e98ac304c981f/screenshots/000-811630216a36-expected.png, runs/ms2oxcxv-fc2bec4f08dd4e2ea18e98ac304c981f/screenshots/000-811630216a36-actual.png, runs/ms2oxcxv-fc2bec4f08dd4e2ea18e98ac304c981f/diffs/000-811630216a36-diff.png
...
|---|---:|---:|---|
| visual_assets | 1.03% | 4054 | 0,30,393x999 |
| text_regions | 1.07% | 3063 | 35,9,310x923 |
| form_controls | 0.00% | 0 | 45,984,305x31 |
| button_icon_controls | 1.23% | 63 | 124,904,142x36 |

##### top failing regions

| region | bucket | diff | pixels | suspectedCauses |
|---|---|---:|---:|---|
| cta | button_icon_controls | 1.23% | 63 | asset_layering, renderer_reset |
| mobile_canvas | - | 1.12% | 4538 | canvas_mapping |
| dense_content | text_regions | 1.07% | 3063 | typography |
| dense_content | visual_assets | 1.03% | 4054 | asset_layering |
