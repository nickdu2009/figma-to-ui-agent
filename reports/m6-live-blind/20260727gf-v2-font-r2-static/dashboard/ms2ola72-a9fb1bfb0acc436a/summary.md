...
- runId: ms2ola72-a9fb1bfb0acc436a
- projectId: m6-live-community-dashboard-001-font-r1
...
- nodes: {"text":114,"input":0,"select":0,"button":0,"image":4,"pixelOverlay":135,"total":378}
...
- visualLayerCoverage: candidate=168, rendered=167, unsupported=1
...
- diffPixels: 71261
- diffPixelRatio: 0.04832695855034722
- screenshots: runs/ms2ola7q-765d1f8b3bf54223b3c6326b111f3289/screenshots/000-72e60729bf19-expected.png, runs/ms2ola7q-765d1f8b3bf54223b3c6326b111f3289/screenshots/000-72e60729bf19-actual.png, runs/ms2ola7q-765d1f8b3bf54223b3c6326b111f3289/diffs/000-72e60729bf19-diff.png
...
|---|---:|---:|---|
| visual_assets | 4.83% | 71261 | 0,0,1440x1024 |
| text_regions | 5.34% | 66853 | 122,30,1288x972 |

##### top failing regions

| region | bucket | diff | pixels | suspectedCauses |
|---|---|---:|---:|---|
| dense_content | text_regions | 5.34% | 66853 | typography |
| dense_content | visual_assets | 4.83% | 71261 | asset_layering |
| dense_content | - | 4.83% | 71261 | renderer_reset |
...
- sourceNodeCount: 496
- visibleNodeCount: 496
- vector: total=262, rendered=181, ignoredSafe=0, unsupported=81, unmapped=0
...
- byReason: {"unsupported_renderer_limit":80,"unsupported_missing_asset":1}
- byKind: {"vector":81}
