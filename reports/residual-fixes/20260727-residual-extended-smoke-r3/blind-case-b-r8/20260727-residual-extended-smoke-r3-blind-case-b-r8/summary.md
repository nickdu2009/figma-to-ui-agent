...
- runId: 20260727-residual-extended-smoke-r3-blind-case-b-r8
...
- visualLayerCoverage: candidate=35, rendered=35, unsupported=2
...
- sourceNodeCount: 75
- visibleNodeCount: 75
- vector: total=41, rendered=18, ignoredSafe=0, unsupported=23, unmapped=0
...
- byReason: {"unsupported_renderer_limit":23}
- byKind: {"vector":23}
