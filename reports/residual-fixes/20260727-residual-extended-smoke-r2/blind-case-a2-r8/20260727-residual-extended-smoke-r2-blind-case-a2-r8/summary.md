...
- runId: 20260727-residual-extended-smoke-r2-blind-case-a2-r8
...
- sourceNodeCount: 82
- visibleNodeCount: 77
- vector: total=29, rendered=17, ignoredSafe=0, unsupported=12, unmapped=0
...
- byReason: {"unsupported_renderer_limit":30,"unsupported_missing_asset":1}
- byKind: {"vector":31}
