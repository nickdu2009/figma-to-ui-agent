...
- runId: 20260727gf-v2-corpus-postcommit-r1-community-v21-dashboard-001
...
- nodes: {"text":114,"input":0,"select":0,"button":0,"image":4,"pixelOverlay":104,"total":338}
...
- visualLayerCoverage: candidate=160, rendered=160, unsupported=8
...
- diffPixels: 65217
- diffPixelRatio: 0.04422810872395833
- screenshots: runs/ms2ms68v-5431eafad56745469620d3a7fd1356a4/screenshots/000-72e60729bf19-expected.png, runs/ms2ms68v-5431eafad56745469620d3a7fd1356a4/screenshots/000-72e60729bf19-actual.png, runs/ms2ms68v-5431eafad56745469620d3a7fd1356a4/diffs/000-72e60729bf19-diff.png
...
|---|---:|---:|---|
| visual_assets | 4.42% | 65217 | 0,0,1440x1024 |
| text_regions | 4.87% | 61022 | 122,30,1288x972 |

##### top failing regions

| region | bucket | diff | pixels | suspectedCauses |
|---|---|---:|---:|---|
| dense_content | text_regions | 4.87% | 61022 | typography |
| dense_content | visual_assets | 4.42% | 65217 | asset_layering |
| dense_content | - | 4.42% | 65217 | renderer_reset |
...
- sourceNodeCount: 496
- visibleNodeCount: 496
- vector: total=262, rendered=174, ignoredSafe=0, unsupported=88, unmapped=0
...
- byReason: {"unsupported_renderer_limit":88}
- byKind: {"vector":88}
