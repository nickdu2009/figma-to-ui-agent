...
- runId: 20260726-generator-fidelity-v1-icon-attribution-community-v21-dashboard-001
...
- nodes: {"text":114,"input":0,"button":0,"image":4,"pixelOverlay":83,"total":317}
- structuredCoverage: text=114, interactive=0
- visualLayerCoverage: candidate=160, rendered=139, unsupported=43
...
- diffPixels: 175627
- diffPixelRatio: 0.11910468207465277
- screenshots: runs/ms1atib0-6dca9990f07d4d0fa49c70b769a5b79f/screenshots/000-72e60729bf19-expected.png, runs/ms1atib0-6dca9990f07d4d0fa49c70b769a5b79f/screenshots/000-72e60729bf19-actual.png, runs/ms1atib0-6dca9990f07d4d0fa49c70b769a5b79f/diffs/000-72e60729bf19-diff.png
...
|---|---:|---:|---|
| visual_assets | 11.91% | 175627 | 0,0,1440x1024 |
| text_regions | 11.90% | 148941 | 122,30,1288x972 |

##### top failing regions

| region | bucket | diff | pixels | suspectedCauses |
|---|---|---:|---:|---|
| left_visual | visual_assets | 11.91% | 175627 | asset_layering |
| mobile_canvas | - | 11.91% | 175627 | canvas_mapping |
| footer | text_regions | 11.90% | 148941 | typography |
...
| 0:276 | nav_icon | icon | true | vl-light---dashboard---1-0-276 |
| 0:292 | nav_icon | icon | true | vl-light---dashboard---1-0-292 |
| 0:310 | nav_icon | icon | true | vl-light---dashboard---1-0-310 |
| 0:330 | nav_icon | icon | true | vl-light---dashboard---1-0-330 |
| 0:348 | nav_icon | icon | true | vl-light---dashboard---1-0-348 |
...
| 0:352 | nav_icon | icon | false | - |
| 0:354 | nav_icon | icon | false | - |
| 0:280 | nav_icon | icon | false | - |
| 0:281 | nav_icon | icon | false | - |
| 0:314 | nav_icon | icon | false | - |
| 0:313 | nav_icon | icon | false | - |
| 0:334 | nav_icon | icon | false | - |
| 0:333 | nav_icon | icon | false | - |
| 0:296 | nav_icon | icon | false | - |
| 0:298 | nav_icon | icon | false | - |
| 0:38 | nav_icon | icon | true | vl-light---dashboard---1-0-38 |
| 0:39 | nav_icon | icon | true | vl-light---dashboard---1-0-39 |
| 0:253 | nav_icon | icon | false | - |
| 0:254 | nav_icon | icon | false | - |
| 0:257 | nav_icon | icon | false | - |
| 0:258 | nav_icon | icon | false | - |
| 0:332 | nav_icon | icon | false | - |
| 0:30 | nav_icon | icon | true | vl-light---dashboard---1-0-30 |
| 0:312 | nav_icon | icon | false | - |
| 0:29 | nav_icon | icon | true | vl-light---dashboard---1-0-29 |
| 0:10 | nav_icon | icon | true | vl-light---dashboard---1-0-10 |
| 0:351 | nav_icon | icon | false | - |
...
| 0:368 | structural_visual | decorative_background | false | - |
| 0:369 | structural_visual | decorative_background | false | - |
...
- sourceNodeCount: 496
- visibleNodeCount: 496
- vector: total=262, rendered=158, ignoredSafe=0, unsupported=104, unmapped=0
...
- byReason: {"unsupported_renderer_limit":83,"unsupported_missing_asset":21}
- byKind: {"vector":104}

- 0:461 (vector, unsupported_missing_asset, area=22908): Combined Shape
- 0:368 (vector, unsupported_missing_asset, area=900): Bg
- 0:369 (vector, unsupported_missing_asset, area=900): Bg
- 0:402 (vector, unsupported_renderer_limit, area=900): Bg
- 0:403 (vector, unsupported_renderer_limit, area=900): Bg
- 0:404 (vector, unsupported_renderer_limit, area=900): Bg
- 0:413 (vector, unsupported_renderer_limit, area=900): Bg
