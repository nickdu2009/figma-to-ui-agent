...
- runId: 20260727gf-v1-2-local-login-r4-community-v21-login-001
...
- viewportRole: mobile
- nodes: {"text":14,"input":2,"button":3,"image":0,"pixelOverlay":12,"total":67}
- structuredCoverage: text=14, interactive=5
- visualLayerCoverage: candidate=21, rendered=19, unsupported=2
...
- diffPixels: 28845
- diffPixelRatio: 0.09472906403940887
- screenshots: runs/ms2ekh65-61cf455c52e74df3998e3d7d39f08ec2/screenshots/000-fcb44a3d7f33-expected.png, runs/ms2ekh65-61cf455c52e74df3998e3d7d39f08ec2/screenshots/000-fcb44a3d7f33-actual.png, runs/ms2ekh65-61cf455c52e74df3998e3d7d39f08ec2/diffs/000-fcb44a3d7f33-diff.png
...
|---|---:|---:|---|
| visual_assets | 11.13% | 28802 | 24,15,328x789 |
| text_regions | 11.76% | 28756 | 24,14,327x748 |
| form_controls | 8.64% | 4437 | 24,263,327x157 |
| button_icon_controls | 22.00% | 15685 | 24,474,327x218 |

##### top failing regions

| region | bucket | diff | pixels | suspectedCauses |
|---|---|---:|---:|---|
| social_buttons | button_icon_controls | 22.00% | 15685 | asset_layering, renderer_reset |
| dense_content | text_regions | 11.76% | 28756 | typography |
| dense_content | visual_assets | 11.13% | 28802 | asset_layering |
| mobile_canvas | - | 9.47% | 28845 | canvas_mapping |
| form_fields | form_controls | 8.64% | 4437 | typography, renderer_reset |
...
| 28:4024 | line_divider | line_or_divider | false | - |
| 28:4026 | line_divider | line_or_divider | false | - |
...
- byReason: {"unsupported_renderer_limit":2,"unsupported_missing_asset":2}
- byKind: {"vector":4}
...
- 28:4024 (vector, unsupported_missing_asset, area=0): Line
- 28:4026 (vector, unsupported_missing_asset, area=0): Line
