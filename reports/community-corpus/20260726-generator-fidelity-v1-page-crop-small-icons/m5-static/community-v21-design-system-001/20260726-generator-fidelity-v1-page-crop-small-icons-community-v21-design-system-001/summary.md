...
- runId: 20260726-generator-fidelity-v1-page-crop-small-icons-community-v21-design-system-001
...
- nodes: {"text":35,"input":9,"button":23,"image":0,"pixelOverlay":38,"total":257}
- structuredCoverage: text=35, interactive=32
- visualLayerCoverage: candidate=44, rendered=43, unsupported=1
...
- diffPixels: 368602
- diffPixelRatio: 0.19423515711041203
- screenshots: runs/ms1dnqyj-c428285fe8b5444fa8b1dd42a63505c9/screenshots/000-6fa923173131-expected.png, runs/ms1dnqyj-c428285fe8b5444fa8b1dd42a63505c9/screenshots/000-6fa923173131-actual.png, runs/ms1dnqyj-c428285fe8b5444fa8b1dd42a63505c9/diffs/000-6fa923173131-diff.png
...
|---|---:|---:|---|
| visual_assets | 4.23% | 47836 | 191,54,1441x785 |
| text_regions | 4.78% | 34648 | 236,77,1306x555 |
| form_controls | 18.11% | 16075 | 598,301,584x152 |
| button_icon_controls | 4.39% | 35054 | 192,70,1396x572 |

##### top failing regions

| region | bucket | diff | pixels | suspectedCauses |
|---|---|---:|---:|---|
| mobile_canvas | - | 19.42% | 368602 | canvas_mapping |
| form_fields | form_controls | 18.11% | 16075 | typography, renderer_reset |
| footer | text_regions | 4.78% | 34648 | typography |
| cta | button_icon_controls | 4.39% | 35054 | asset_layering, renderer_reset |
| social_buttons | button_icon_controls | 4.39% | 35054 | asset_layering, renderer_reset |
| left_visual | visual_assets | 4.23% | 47836 | asset_layering |
...
| I14:4584;5:2384 | nav_icon | icon | true | vl-in-modals-I14-4584-5-2384 |
| I13:18308;5173:445784;5:2384 | nav_icon | icon | true | vl-in-modals-I13-18308-5173-445784-5-2384 |
| 21:2379 | nav_icon | icon | true | vl-in-modals-21-2379 |
| 21:2412 | nav_icon | icon | true | vl-in-modals-21-2412 |
| 21:2423 | nav_icon | icon | true | vl-in-modals-21-2423 |
| 21:2435 | nav_icon | icon | true | vl-in-modals-21-2435 |
| 21:2447 | nav_icon | icon | true | vl-in-modals-21-2447 |
| 21:2389 | nav_icon | icon | true | vl-in-modals-21-2389 |
| 21:2401 | nav_icon | icon | true | vl-in-modals-21-2401 |
...
- sourceNodeCount: 329
- visibleNodeCount: 301
- vector: total=95, rendered=46, ignoredSafe=2, unsupported=47, unmapped=0
...
- byReason: {"unsupported_renderer_limit":51,"unsupported_missing_asset":1}
- byKind: {"vector":47,"unsupported":1,"container":4}
