...
- runId: 20260726-generator-fidelity-v1-page-crop-small-icons-community-v21-dashboard-001
...
- nodes: {"text":114,"input":0,"button":0,"image":4,"pixelOverlay":135,"total":371}
- structuredCoverage: text=114, interactive=0
- visualLayerCoverage: candidate=160, rendered=159, unsupported=15
...
- diffPixels: 98452
- diffPixelRatio: 0.06676703559027777
- screenshots: runs/ms1dnm5e-c00f099551f141708591750f3b72d369/screenshots/000-72e60729bf19-expected.png, runs/ms1dnm5e-c00f099551f141708591750f3b72d369/screenshots/000-72e60729bf19-actual.png, runs/ms1dnm5e-c00f099551f141708591750f3b72d369/diffs/000-72e60729bf19-diff.png
...
|---|---:|---:|---|
| visual_assets | 6.68% | 98452 | 0,0,1440x1024 |
| text_regions | 7.51% | 93965 | 122,30,1288x972 |

##### top failing regions

| region | bucket | diff | pixels | suspectedCauses |
|---|---|---:|---:|---|
| footer | text_regions | 7.51% | 93965 | typography |
| left_visual | visual_assets | 6.68% | 98452 | asset_layering |
| mobile_canvas | - | 6.68% | 98452 | canvas_mapping |
...
- sourceNodeCount: 496
- visibleNodeCount: 496
- vector: total=262, rendered=172, ignoredSafe=0, unsupported=90, unmapped=0
...
- byReason: {"unsupported_renderer_limit":89,"unsupported_missing_asset":1}
- byKind: {"vector":90}

- 0:461 (vector, unsupported_missing_asset, area=22908): Combined Shape
- 0:430 (vector, unsupported_renderer_limit, area=900): Bg
- 0:431 (vector, unsupported_renderer_limit, area=900): Bg
- 0:432 (vector, unsupported_renderer_limit, area=900): Bg
- 0:433 (vector, unsupported_renderer_limit, area=900): Bg
- 0:440 (vector, unsupported_renderer_limit, area=900): Bg
- 0:121 (vector, unsupported_renderer_limit, area=400): Rectangle 8
