...
- runId: 20260726gf-tinyfillshape-community-v21-design-system-001
...
- nodes: {"text":35,"input":9,"button":23,"image":0,"pixelOverlay":30,"total":250}
- structuredCoverage: text=35, interactive=32
- visualLayerCoverage: candidate=39, rendered=38, unsupported=1
...
- diffPixels: 273145
- diffPixelRatio: 0.16162464289856307
- screenshots: runs/ms1fl5cv-2c2cec41c42943f498dd36aabd8c558a/screenshots/000-6fa923173131-expected.png, runs/ms1fl5cv-2c2cec41c42943f498dd36aabd8c558a/screenshots/000-6fa923173131-actual.png, runs/ms1fl5cv-2c2cec41c42943f498dd36aabd8c558a/diffs/000-6fa923173131-diff.png
...
|---|---:|---:|---|
| visual_assets | 4.85% | 54858 | 191,54,1441x785 |
| text_regions | 5.34% | 38730 | 236,77,1306x555 |
| form_controls | 19.51% | 17323 | 598,301,584x152 |
| button_icon_controls | 4.91% | 39187 | 192,70,1396x572 |

##### top failing regions

| region | bucket | diff | pixels | suspectedCauses |
|---|---|---:|---:|---|
| form_fields | form_controls | 19.51% | 17323 | typography, renderer_reset |
| modal_shell | - | 16.16% | 273145 | renderer_reset |
| footer | text_regions | 5.34% | 38730 | typography |
| cta | button_icon_controls | 4.91% | 39187 | asset_layering, renderer_reset |
| social_buttons | button_icon_controls | 4.91% | 39187 | asset_layering, renderer_reset |
| left_visual | visual_assets | 4.85% | 54858 | asset_layering |
...
| 14:4201 | nav_icon | icon | true | vl-in-modals-14-4201 |
...
| 14:4202 | nav_icon | icon | true | vl-in-modals-14-4202 |
| 14:4204 | nav_icon | icon | true | vl-in-modals-14-4204 |
| I13:18321;2:1582;11:17029;13:18116 | nav_icon | icon | true | vl-in-modals-I13-18321-2-1582-11-17029-13-18116 |
...
- sourceNodeCount: 329
- visibleNodeCount: 301
- vector: total=95, rendered=41, ignoredSafe=2, unsupported=52, unmapped=0
...
- byReason: {"unsupported_renderer_limit":56,"unsupported_missing_asset":1}
- byKind: {"vector":52,"unsupported":1,"container":4}
...
- I21:2366;5:37110 (unsupported, unsupported_renderer_limit, area=62): Polygon 2
- 21:2451 (vector, unsupported_renderer_limit, area=59): Vector
- 21:2404 (vector, unsupported_renderer_limit, area=55): Vector
- 21:2415 (vector, unsupported_renderer_limit, area=55): Vector
