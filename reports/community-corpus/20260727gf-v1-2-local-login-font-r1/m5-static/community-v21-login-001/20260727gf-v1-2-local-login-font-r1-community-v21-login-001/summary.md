...
- runId: 20260727gf-v1-2-local-login-font-r1-community-v21-login-001
...
- viewportRole: mobile
- nodes: {"text":14,"input":2,"button":3,"image":0,"pixelOverlay":12,"total":69}
...
- diffPixels: 27476
- diffPixelRatio: 0.09023316912972085
- screenshots: runs/ms2ep3y1-18fbd301f7d04505b59383cf4006d664/screenshots/000-fcb44a3d7f33-expected.png, runs/ms2ep3y1-18fbd301f7d04505b59383cf4006d664/screenshots/000-fcb44a3d7f33-actual.png, runs/ms2ep3y1-18fbd301f7d04505b59383cf4006d664/diffs/000-fcb44a3d7f33-diff.png
...
|---|---:|---:|---|
| visual_assets | 10.60% | 27433 | 24,15,328x789 |
| text_regions | 11.20% | 27387 | 24,14,327x748 |
| form_controls | 8.53% | 4378 | 24,263,327x157 |
| button_icon_controls | 22.55% | 16072 | 24,474,327x218 |

##### top failing regions

| region | bucket | diff | pixels | suspectedCauses |
|---|---|---:|---:|---|
| social_buttons | button_icon_controls | 22.55% | 16072 | asset_layering, renderer_reset |
| dense_content | text_regions | 11.20% | 27387 | typography |
| dense_content | visual_assets | 10.60% | 27433 | asset_layering |
| mobile_canvas | - | 9.02% | 27476 | canvas_mapping |
| form_fields | form_controls | 8.53% | 4378 | typography, renderer_reset |
