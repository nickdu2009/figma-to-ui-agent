...
- runId: 20260726gf-stroke-icon-diag-community-v21-dashboard-001
...
- nodes: {"text":114,"input":0,"button":0,"image":4,"pixelOverlay":118,"total":354}
- structuredCoverage: text=114, interactive=0
- visualLayerCoverage: candidate=160, rendered=141, unsupported=41
...
- diffPixels: 106184
- diffPixelRatio: 0.07201063368055556
- screenshots: runs/ms1kremq-0ea90e6f3b044d9386e6f3a448c73790/screenshots/000-72e60729bf19-expected.png, runs/ms1kremq-0ea90e6f3b044d9386e6f3a448c73790/screenshots/000-72e60729bf19-actual.png, runs/ms1kremq-0ea90e6f3b044d9386e6f3a448c73790/diffs/000-72e60729bf19-diff.png
...
|---|---:|---:|---|
| visual_assets | 7.20% | 106184 | 0,0,1440x1024 |
| text_regions | 8.15% | 101989 | 122,30,1288x972 |

##### top failing regions

| region | bucket | diff | pixels | suspectedCauses |
|---|---|---:|---:|---|
| dense_content | text_regions | 8.15% | 101989 | typography |
| dense_content | visual_assets | 7.20% | 106184 | asset_layering |
| dense_content | - | 7.20% | 106184 | renderer_reset |
...
- sourceNodeCount: 496
- visibleNodeCount: 496
- vector: total=262, rendered=160, ignoredSafe=0, unsupported=102, unmapped=0
...
- byReason: {"unsupported_renderer_limit":83,"unsupported_missing_asset":19}
- byKind: {"vector":102}
