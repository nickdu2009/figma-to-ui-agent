...
- runId: ms14q3y9-434145e81ad94ed0
- projectId: community-v2-dashboard-001
...
- nodes: {"text":114,"input":0,"button":0,"image":4,"pixelOverlay":108,"total":342}
- structuredCoverage: text=114, interactive=0
- visualLayerCoverage: candidate=108, rendered=108, unsupported=0
...
- sourceNodeCount: 496
- visibleNodeCount: 496
- vector: total=262, rendered=108, ignoredSafe=8, unsupported=146, unmapped=0
...
- byReason: {"unsupported_renderer_limit":146}
- byKind: {"vector":146}

- 0:241 (vector, unsupported_renderer_limit, area=54188): Path 2
- 0:238 (vector, unsupported_renderer_limit, area=3480): Combined Shape
- 0:236 (vector, unsupported_renderer_limit, area=3200): Rectangle 10
- 0:152 (vector, unsupported_renderer_limit, area=1600): Mask
- 0:151 (vector, unsupported_renderer_limit, area=1600): Mask
- 0:171 (vector, unsupported_renderer_limit, area=1600): Mask
- 0:170 (vector, unsupported_renderer_limit, area=1600): Mask
- 0:190 (vector, unsupported_renderer_limit, area=1600): Mask
- 0:189 (vector, unsupported_renderer_limit, area=1600): Mask
- 0:245 (vector, unsupported_renderer_limit, area=1600): Rectangle 8
...
- **unmapped_node_vector**: 未映射的节点类型 vector: 0:152
- **unmapped_node_vector**: 未映射的节点类型 vector: 0:151
- **unmapped_node_vector**: 未映射的节点类型 vector: 0:163
- **unmapped_node_vector**: 未映射的节点类型 vector: 0:171
- **unmapped_node_vector**: 未映射的节点类型 vector: 0:170
- **unmapped_node_vector**: 未映射的节点类型 vector: 0:182
- **unmapped_node_vector**: 未映射的节点类型 vector: 0:190
- **unmapped_node_vector**: 未映射的节点类型 vector: 0:189
...
- **unmapped_node_vector**: 未映射的节点类型 vector: 0:238
- **unmapped_node_vector**: 未映射的节点类型 vector: 0:241
- **unmapped_node_vector**: 未映射的节点类型 vector: 0:244
- **unmapped_node_vector**: 未映射的节点类型 vector: 0:245
