...
- runId: ms14qogh-c7eea17806164121
- projectId: community-v2-landing-001
...
- nodes: {"text":13,"input":0,"button":0,"image":0,"pixelOverlay":1,"total":106}
...
- sourceNodeCount: 396
- visibleNodeCount: 396
- vector: total=291, rendered=0, ignoredSafe=244, unsupported=47, unmapped=0
...
- byReason: {"unsupported_renderer_limit":47}
- byKind: {"vector":47}

- 12:633 (vector, unsupported_renderer_limit, area=2450): Rectangle 157
- 14:958 (vector, unsupported_renderer_limit, area=2450): Rectangle 157
- 14:1003 (vector, unsupported_renderer_limit, area=2450): Rectangle 157
- 211:825 (vector, unsupported_renderer_limit, area=1650): Vector
- 211:853 (vector, unsupported_renderer_limit, area=1650): Vector
- 211:819 (vector, unsupported_renderer_limit, area=1600): Vector
- 13:637 (vector, unsupported_renderer_limit, area=1296): Vector
- 211:822 (vector, unsupported_renderer_limit, area=1120): Vector
- 211:846 (vector, unsupported_renderer_limit, area=1107): Vector
- 14:976 (vector, unsupported_renderer_limit, area=1075): Vector
...
- **unmapped_node_vector**: 未映射的节点类型 vector: 211:819
- **unmapped_node_vector**: 未映射的节点类型 vector: 211:822
- **unmapped_node_vector**: 未映射的节点类型 vector: 211:825
- **unmapped_node_vector**: 未映射的节点类型 vector: 211:826
...
- **unmapped_node_vector**: 未映射的节点类型 vector: 211:846
- **unmapped_node_vector**: 未映射的节点类型 vector: 211:849
- **unmapped_node_vector**: 未映射的节点类型 vector: 211:850
- **unmapped_node_vector**: 未映射的节点类型 vector: 211:853
- **unmapped_node_vector**: 未映射的节点类型 vector: 211:854
- **unmapped_node_vector**: 未映射的节点类型 vector: 12:633
- **unmapped_node_vector**: 未映射的节点类型 vector: 13:637
- **unmapped_node_vector**: 未映射的节点类型 vector: 14:958
...
- **unmapped_node_vector**: 未映射的节点类型 vector: 14:976
- **unmapped_node_vector**: 未映射的节点类型 vector: 14:1003
