...
- runId: ms14qck7-9decd6cd6f024deb
- projectId: community-v2-ecommerce-001
...
- byReason: {"unsupported_renderer_limit":28}
- byKind: {"vector":28}

- 0:304 (vector, unsupported_renderer_limit, area=16720): Rectangle
- 0:351 (vector, unsupported_renderer_limit, area=576): Rectangle
- 0:363 (vector, unsupported_renderer_limit, area=529): Rectangle
- 0:356 (vector, unsupported_renderer_limit, area=482): Combined Shape
- 0:368 (vector, unsupported_renderer_limit, area=449): Shape
- 0:367 (vector, unsupported_renderer_limit, area=449): Path
- 0:345 (vector, unsupported_renderer_limit, area=378): home 
- 0:343 (vector, unsupported_renderer_limit, area=378): Path
- 0:361 (vector, unsupported_renderer_limit, area=267): Combined Shape
- 0:360 (vector, unsupported_renderer_limit, area=267): Fill 19
