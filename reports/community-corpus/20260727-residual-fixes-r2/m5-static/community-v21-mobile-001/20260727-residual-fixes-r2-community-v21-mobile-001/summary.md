...
- runId: 20260727-residual-fixes-r2-community-v21-mobile-001
...
- viewportRole: tablet
- nodes: {"text":24,"input":0,"select":0,"button":1,"image":1,"pixelOverlay":14,"total":60}
...
- diffPixels: 6589
- diffPixelRatio: 0.016293394857034054
- screenshots: runs/ms2qca3k-dafe07c8ec69411faca8c0984a9a1afa/screenshots/000-811630216a36-expected.png, runs/ms2qca3k-dafe07c8ec69411faca8c0984a9a1afa/screenshots/000-811630216a36-actual.png, runs/ms2qca3k-dafe07c8ec69411faca8c0984a9a1afa/diffs/000-811630216a36-diff.png
...
|---|---:|---:|---|
| visual_assets | 1.45% | 5681 | 0,30,393x999 |
| text_regions | 1.10% | 3139 | 35,9,310x923 |
| form_controls | 0.00% | 0 | 45,984,305x31 |
| button_icon_controls | 0.60% | 644 | 124,188,142x752 |

##### top failing regions

| region | bucket | diff | pixels | suspectedCauses |
|---|---|---:|---:|---|
| mobile_canvas | - | 1.63% | 6589 | canvas_mapping |
| dense_content | visual_assets | 1.45% | 5681 | asset_layering |
| dense_content | text_regions | 1.10% | 3139 | typography |
| cta | button_icon_controls | 0.60% | 644 | asset_layering, renderer_reset |
